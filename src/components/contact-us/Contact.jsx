        ...
        <div className="bg-white p-6 rounded-lg shadow-md space-y-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <p className="text-base sm:text-lg font-semibold text-gray-700 flex flex-col md:flex-row ">
              <span className="text-nowrap"> +974 70809767 &nbsp;</span>
              <span className="text-nowrap">+974 70809768</span>
            </p>
          </div>
          <hr className="border-gray-300" />
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-base sm:text-lg font-semibold text-gray-700">
              Doha – Al Muntazah – Street 830, Building 16
            </span>
          </div>
        </div>
      </div>
