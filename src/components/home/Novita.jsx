        ...
        <div className=" h-fit relative mt-6">
            ...
            <div className=" w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className=" w-full sm:w-[80%] h-auto p-10">
                    <h4 className=" text-xs font-semibold">Prioritize impactful tasks that drive the most value.</h4>
                    <h1 className="  tex-xl sm:text-5xl font-semibold">
                        Novieta Plus-Integrated Advertising and Marketing Solutions
                    </h1>
                    <p className=" mt-2 ">Novieta Plus delivers innovative and comprehensive advertising solutions. We focus on providing high-quality marketing services that help build a strong brand identity, enhance visibility, and increase engagement with the target audience across multiple channels.</p>
                </div>
