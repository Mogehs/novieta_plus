...
const WebDesign = () => {
  ...
  const content = {
    en: {
      ...
      description:
        "At Novieta Plus, we specialize in crafting visually stunning and highly functional websites tailored to your business needs.",
      services: [
    ...
    ar: {
      ...
      description:
        "نحن في نوفيا بلس متخصصون في إنشاء مواقع ويب جذابة وعالية الأداء تلبي احتياجات عملك.",
      services: [
        "تصميم مواقع مخصصة",
        "تطوير مواقع متجاوبة",
        "حلول التجارة الإلكترونية",
        "تصميم وتحسين واجهة المستخدم وتجربة المستخدم",
      ],
    },
  };
